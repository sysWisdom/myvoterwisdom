...
# Define file paths
csv_path = 'c:/Users/macki/Documents/VS Studio Code/WisdomAI_2020/data/reasoning/simulated_questions.csv'
index_path = 'voter_questions.index'
csv_output_path = 'voter_questions_data.csv'
